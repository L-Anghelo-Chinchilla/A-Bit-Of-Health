...
class FoodProvider {
  ...
  Future<Map<String,FoodRegister>> getUserRegister(String userID, String date) async {
   ...
   // var f = FoodOffer.fromJson(jsonDecode(s));
    var f = FoodOffer(typeOfFood: 'Desayuno', aliments: [Food(calories: 10),Food(calories: 20),Food(calories: 5),Food(calories: 17)]);     
    ...
    print(r.toJson());
    var l = await http.post(url , body: r.toJson().toString());
    print(l.body);
    final answer = await http.get(url);
